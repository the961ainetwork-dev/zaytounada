...
export const CULINARY_EVENTS: CulinaryEvent[] = [
  {
    id: 'evt-1',
    title: 'The Beirut Street Food & Souk El Tayeb Festival',
    description: 'An expansive, outdoor celebration of traditional Lebanese street food, piping-hot wood-fired manoushehs, and regional family mezze recipes. Master bakers and home cooks from all regional cooperatives gather in Downtown Beirut to present authentic heritage cooking.',
    excerpt: 'An outdoor celebration of traditional street food, manoushehs, and dynamic mezza from various Lebanese regions.',
    date: 'May 20-22, 2026',
    timeString: '12:00 PM - 10:00 PM',
    venueName: 'Downtown Heritage Souks',
    city: 'Beirut',
    neighborhood: 'sodeco',
    coordinates: { lat: 33.8965, lng: 35.5015 },
    imageUrl: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80&w=800',
    ticketPrice: 'Free Entry (Pay per plate)',
    organizer: 'Souk El Tayeb Cooperative',
    tags: ['Street Food', 'Traditional', 'Family Friendly']
  },
  {
    id: 'evt-2',
    title: 'Hamra Street Sunset Arak & Tapas Festival',
    description: 'A magnificent, multi-street pedestrian culinary trail celebrating traditional triple-distilled Lebanese arak, creative modern gastro-bites, and street-side acoustic concerts. Visitors can purchase custom tasting glasses to sample over 25 craft distilleries.',
    excerpt: 'A dynamic pedestrian culinary trail celebrating triple-distilled Lebanese arak and creative gastro-tapas in Hamra.',
    date: 'June 4-6, 2026',
    timeString: '5:00 PM - 12:00 AM',
    venueName: 'Makdessi & Mahatma Gandhi Streets',
    city: 'Beirut',
    neighborhood: 'hamra',
    coordinates: { lat: 33.8962, lng: 35.4820 },
    imageUrl: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?auto=format&fit=crop&q=80&w=800',
    ticketPrice: '$15 (Includes Tasting Cup & 3 Drinks)',
    organizer: 'Hamra Merchants Association',
    tags: ['Nightlife', 'Arak Tasting', 'Live Music']
  },
  {
    id: 'evt-3',
    title: 'Antelias Sea-to-Plate Seafood & Wine Gala',
    description: 'A luxurious waterfront festival celebrating Jounieh Bay fresh catches, charcoal-grilled giant red mullets, salt-baked fish, and premium dry white wines from Lebanon’s finest wineries. Features live table-side fish-carving demonstrations by master chefs.',
    excerpt: 'A premium waterfront gala celebrating fresh Mediterranean catches, salt-baked fish, and dry white wine pairings.',
    date: 'June 15-18, 2026',
    timeString: '7:00 PM - 11:30 PM',
    venueName: 'Antelias Marina Waterfront Promenade',
    city: 'Antelias',
    neighborhood: 'antelias',
    coordinates: { lat: 33.9160, lng: 35.5890 },
    imageUrl: 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&q=80&w=800',
    ticketPrice: '$45 (Premium Seating & Food Included)',
    organizer: 'Mediterranean Marine Cuisine Council',
    tags: ['Seafood', 'Wine Pairing', 'Luxury']
  },
  {
    id: 'evt-4',
    title: 'Byblos Ancient Harbor Fish Barbecue & Jazz Nights',
    description: 'Enjoy fresh, hand-netted coastal catches roasted beautifully over olive-tree embers on the shores of Byblos\' ancient Phoenician harbor. Accompanied by soothing, live acoustic jazz trios playing classical and contemporary pieces.',
    excerpt: 'Fresh coastal catches grilled over olive-wood embers paired with live acoustic jazz at Byblos’ harbor.',
    date: 'June 25, 2026',
    timeString: '8:00 PM - 1:00 AM',
    venueName: 'Byblos Ancient Citadel Port Deck',
    city: 'Byblos',
    coordinates: { lat: 34.1205, lng: 35.6465 },
    imageUrl: 'https://images.unsplash.com/photo-1476224203421-9ac39bcb3327?auto=format&fit=crop&q=80&w=800',
    ticketPrice: '$25 (Includes Fish Platter)',
    organizer: 'Byblos Historic Preservation Society',
    tags: ['Citadel Barbecue', 'Jazz Music', 'Romantic']
  },
  {
    id: 'evt-5',
    title: 'Batroun Beachfront Craft Beer & Burger Expo',
    description: 'Lebanon’s pioneering beach-party culinary expo. Taste golden, organic beers brewed on site with mountain spring water paired with gourmet charcoal-seared local brisket burgers, smoked sausages, and live summer DJs.',
    excerpt: 'Beachfront gathering of organic craft microbreweries and local street vendors offering gourmet burgers.',
    date: 'July 2-4, 2026',
    timeString: '2:00 PM - 11:00 PM',
    venueName: 'Batroun Public Beach Coastline',
    city: 'Batroun',
    coordinates: { lat: 34.2562, lng: 35.6565 },
    imageUrl: 'https://images.unsplash.com/photo-1568219656418-15c329c72fd3?auto=format&fit=crop&q=80&w=800',
    ticketPrice: '$10 (Includes 1 Craft Beer)',
    organizer: 'Batroun Coastal Brewers Syndicate',
    tags: ['Beach Party', 'Craft Beer', 'Burgers']
  },
  {
    id: 'evt-6',
    title: 'Bekaa Organic Harvest & Farm-to-Table Feast',
    description: 'A spectacular afternoon banquet in the middle of West Bekaa vineyards. Savour an organic 7-course meal prepared entirely with freshly harvested mountain greens, heirloom sumac seeds, local olive oils, and biodynamic wines.',
    excerpt: 'An organic afternoon banquet highlighting West Bekaa wild herbs, sumac seeds, and biodynamic wines.',
    date: 'July 12, 2026',
    timeString: '1:00 PM - 6:00 PM',
    venueName: 'Tawlet Ammiq Gardens, Bekaa',
    city: 'Beirut',
    coordinates: { lat: 33.8820, lng: 35.8010 },
    imageUrl: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&q=80&w=800',
    ticketPrice: '$55 (All-Inclusive Organic Banquet)',
    organizer: 'Bekaa Valley Biodynamic Cooperative',
    tags: ['Farm-to-Table', 'Organic', 'Wine Tasting']
  },
  {
    id: 'evt-7',
    title: 'Hamod W Harr Live-Microbiome Probiotic Tasting',
    description: 'An exceptional pop-up laboratory and raw fermentation workshop hosted by Hamod W Harr. Taste 10 exclusive styles of live-active kimchis, fermented garlic toum paste, dynamic cider vinegars, and aged herbal cheeses. Meet the chief fermentation alchemist!',
    excerpt: 'Join Hamod W Harr’s chief alchemist for an exclusive live-active probiotic food & drink tasting session in Hamra.',
    date: 'July 25-27, 2026',
    timeString: '4:00 PM - 9:00 PM',
    venueName: 'Hamod W Harr Laboratory Deck (Zaroubi Alleyway)',
    city: 'Beirut',
    neighborhood: 'hamra',
    coordinates: { lat: 33.8960, lng: 35.4815 },
    imageUrl: 'https://images.unsplash.com/photo-1583224964978-2257b960c3d3?auto=format&fit=crop&q=80&w=800',
    ticketPrice: 'Free Entry (Lacto-samples included)',
    organizer: 'Hamod W Harr Labs',
    tags: ['Probiotic', 'Fermentation Workshop', 'Specialty']
  },
  {
    id: 'evt-8',
    title: 'Mar Mikhael Artisanal Mouneh & Natural Wine Fair',
    description: 'A vibrant weekend gathering of Lebanon’s most progressive food preserving cooperatives and small-batch natural winemakers. Features stone-ground heirloom grains, forest honey varieties, sumac preserves, and zero-sulfite low-intervention wines.',
    excerpt: 'A weekend celebration showcasing organic small-batch preserve makers, wild honey varieties, and premium natural wines.',
    date: 'August 10-12, 2026',
    timeString: '3:00 PM - 11:00 PM',
    venueName: 'Mar Mikhael Creative Courtyard',
    city: 'Beirut',
    neighborhood: 'mar_mikhael',
    coordinates: { lat: 33.8978, lng: 35.5180 },
    imageUrl: 'https://images.unsplash.com/photo-1552767059-ce182ead6c1b?auto=format&fit=crop&q=80&w=800',
    ticketPrice: '$10 (Includes Tasting Pass)',
    organizer: 'Levantine Preservation Guild',
    tags: ['Artisanal Mouneh', 'Natural Wine', 'Heritage']
  },
  {
    id: 'evt-9',
    title: 'Sassine Square Fig, Honey & Goat Labneh Fest',
    description: 'Immerse yourself in traditional mountain dairy crafts. Master cheesemakers from the Mount Lebanon ridges demonstrate the ancient art of suspending goat labneh in olive oil jars infused with wild thyme and sun-dried figs.',
    excerpt: 'Learn ancient mountain preserving methods for goat dairy and sun-dried autumn fruits in Sassine.',
    date: 'September 5, 2026',
    timeString: '11:00 AM - 8:00 PM',
    venueName: 'Sassine Esplanade & Promenade',
    city: 'Beirut',
    neighborhood: 'sassine',
    coordinates: { lat: 33.8885, lng: 35.5212 },
    ...
    organizer: 'Mount Lebanon Herders Guild',
    tags: ['Goat Dairy', 'Traditional Crafts', 'Local Produce']
  },
  {
    id: 'evt-10',
    title: 'Badaro Chestnut Roasting & Apple Cider Evenings',
    description: 'Warm up your evening in the leafy neighborhood of Badaro. Experience open-fire chestnut roasting, spiced warm organic apple cider brewed with mountain vinegar mothers, and acoustic indie folks music under the pine trees.',
    excerpt: 'Gather for open-fire chestnut roasting and warm spiced cider brewed from wild mountain apples in Badaro.',
    date: 'October 18-20, 2026',
    timeString: '6:00 PM - 11:30 PM',
    venueName: 'Badaro Green Plaza and Alleyways',
    city: 'Beirut',
    neighborhood: 'badaro',
    coordinates: { lat: 33.8785, lng: 35.5120 },
    imageUrl: 'https://images.unsplash.com/photo-1622484211148-716598e04141?auto=format&fit=crop&q=80&w=800',
    ticketPrice: '$8 (Includes Roasted Chestnut Cone)',
    organizer: 'Badaro Community Initiative',
    tags: ['Autumn Fest', 'Spiced Cider', 'Cozy Vibes']
  }
];
